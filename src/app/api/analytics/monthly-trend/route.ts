...
export async function GET(request: NextRequest) {
  try {
    ...
    // Correctly compute startDate by rolling back N-1 months from current month
    ...
    // normalized_amount is always positive for both income and expense
    // transaction_type tells us whether it's income or expense
